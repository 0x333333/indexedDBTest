        ...
        function derez(e, t) {
          ...
          if (!("object" != typeof e || null === e || e instanceof Boolean || e instanceof Date || e instanceof Number || e instanceof RegExp || e instanceof Blob || e instanceof String)) {
            ...
            if (objects.push(e), paths.push(t), "[object Array]" === Object.prototype.toString.apply(e))
              for (i = [], n = 0; e.length > n; n += 1) i[n] = derez(e[n], t + "[" + n + "]");
            else {
              i = {};
        ...
        function rez(value) {
          ...
          if (value && "object" == typeof value)
            if ("[object Array]" === Object.prototype.toString.apply(value))
              for (i = 0; value.length > i; i += 1) item = value[i], item && "object" == typeof item && (path = item.$ref, value[i] = "string" == typeof path && px.test(path) ? eval(path) : rez(item));
            else
          if (void 0 !== value.$type) switch (value.$type) {
            case "blob":
            case "file":
...
function(e, t) {
  ...
  n.prototype.__find = function(n, o, i, r) {
    ...
    s.push("WHERE ", a.__keyColumnName, " NOT NULL"), a.__range && (a.__range.lower || a.__range.upper) && (s.push("AND"), a.__range.lower && (s.push(a.__keyColumnName + (a.__range.lowerOpen ? " >" : " >= ") + " ?"), u.push(e.Key.encode(a.__range.lower))), a.__range.lower && a.__range.upper && s.push("AND"), a.__range.upper && (s.push(a.__keyColumnName + (a.__range.upperOpen ? " < " : " <= ") + " ?"), u.push(e.Key.encode(a.__range.upper)))), n !== t && (a.__lastKeyContinued = n, a.__offset = 0), a.__lastKeyContinued !== t && (s.push("AND " + a.__keyColumnName + " >= ?"), u.push(e.Key.encode(a.__lastKeyContinued))), s.push("ORDER BY ", a.__keyColumnName), s.push("LIMIT 1 OFFSET " + a.__offset), e.DEBUG && console.log(s.join(" "), u), o.executeSql(s.join(" "), u, function(n, o) {
      if (1 === o.rows.length) {
        var r = e.Key.decode(o.rows.item(0)[a.__keyColumnName]),
          s = e.Key.decode(o.rows.item(0).key),
          u = "value" === a.__valueColumnName ? e.Sca.decode(o.rows.item(0)[a.__valueColumnName]) : e.Key.decode(o.rows.item(0)[a.__valueColumnName]);
        i(r, u, s)
    ...
    this.__idbObjectStore.transaction.__addToTransactionQueue(function(o, i, r, a) {
      n.__offset++, n.__find(e, o, function(e, o, i) {
        n.key = e, n.value = o, n.primaryKey = i, r(n.key !== t ? n : t, n.__req)
      }, function(e) {
        a(e)
      })
    })
    ...
    return e.Sca.encode(n, function(n) {
      o.__idbObjectStore.transaction.__pushToQueue(i, function(i, r, a, s) {
        o.__find(t, i, function(t, r, u) {
          var c = "UPDATE " + e.util.quote(o.__idbObjectStore.name) + " SET value = ? WHERE key = ?";
          e.DEBUG && console.log(c, n, t, u), i.executeSql(c, [n, e.Key.encode(u)], function(e, n) {
    ...
    return this.__idbObjectStore.transaction.__addToTransactionQueue(function(o, i, r, a) {
      n.__find(t, o, function(i, s, u) {
        var c = "DELETE FROM  " + e.util.quote(n.__idbObjectStore.name) + " WHERE key = ?";
        e.DEBUG && console.log(c, i, u), o.executeSql(c, [e.Key.encode(u)], function(e, o) {
          1 === o.rowsAffected ? (n.__offset--, r(t)) : a("No rows with key found" + i)
        }, function(e, t) {
          a(t)
        })
      }, function(e) {
  ...
  IDBIndex.prototype.__createIndex = function(indexName, keyPath, optionalParameters) {
    ...
    return n.__idbObjectStore.transaction.__addToTransactionQueue(function(o, i, r, a) {
      ...
      e !== undefined && (s.push("AND", n.indexName, " = ?"), u.push(idbModules.Key.encode(e))), idbModules.DEBUG && console.log("Trying to fetch data for Index", s.join(" "), u), o.executeSql(s.join(" "), u, function(e, n) {
        var o;
        o = "count" === t ? n.rows.length : 0 === n.rows.length ? undefined : "key" === t ? idbModules.Key.decode(n.rows.item(0).key) : idbModules.Sca.decode(n.rows.item(0).value), r(o)
      }, a)
    })
...
function(idbModules) {
  ...
  IDBObjectStore.prototype.__setReadyState = function(e, t) {
    ...
    if (t !== void 0) n = this.__ready[t] === void 0 ? !0 : this.__ready[t];
      ...
      for (var o in this.__ready) this.__ready[o] || (n = !1); if (n) e();
    else {
    ...
    me.__getStoreProps(tx, function(props) {
      if (props || idbModules.util.throwDOMException(0, "Data Error - Could not locate defination for this table", props), props.keyPath)
        if (key !== void 0 && idbModules.util.throwDOMException(0, "Data Error - The object store uses in-line keys and the key parameter was provided", props), value) try {
    ...
    return idbModules.Sca.encode(e, function(i) {
      n.transaction.__pushToQueue(o, function(o, r, a, s) {
        n.__deriveKey(o, e, t, function(t) {
          var r = "DELETE FROM " + idbModules.util.quote(n.name) + " where key = ?";
          o.executeSql(r, [idbModules.Key.encode(t)], function(o, r) {
            idbModules.DEBUG && console.log("Did the row with the", t, "exist? ", r.rowsAffected), n.__insertData(o, i, e, t, a, s)
          }, function(e, t) {
            s(t)
          })
        })
